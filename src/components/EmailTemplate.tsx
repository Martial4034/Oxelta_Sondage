  ...
  <div style={{ fontFamily: 'Arial, sans-serif', margin: 0, padding: 0, backgroundColor: '#f4f4f4' }}>
    <div style={{ maxWidth: '600px', margin: '0 auto', backgroundColor: '#ffffff', boxShadow: '0 0 10px rgba(0, 0, 0, 0.1)', borderRadius: '8px', overflow: 'hidden' }}>
      ...
      <div style={{ padding: '20px', textAlign: 'center', backgroundColor: '#ffffff' }}>
        <a href="https://drive.google.com/file/d/1QRQ3wGeuKL0HvPcTx-uXW-dfUK-SbiuB/view" style={{ display: 'inline-block', padding: '0px 0px', color: '#ffffff', backgroundColor: '#25A6D5', borderRadius: '4px', textDecoration: 'none', fontSize: '1px' }}>Voir la documentation</a>
      </div>
    </div>
  </div>
);