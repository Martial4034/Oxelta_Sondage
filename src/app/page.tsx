...
const translations: Record<Language, { [key: string]: string }> = {
  en: {
    ...
    comments: "Oxelta will create this. Do you have any comments or suggestions to share ?",
  ...
  fr: {
    mobileGames: "Joues-tu à des jeux vidéo mobiles ?",
    blockchainKnowledge: "Connais-tu la technologie de la blockchain ?",
    ...
    comments: "Oxelta va créer cela. As-tu des commentaires ou des suggestions à partager ?",
